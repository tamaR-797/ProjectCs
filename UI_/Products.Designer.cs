namespace UI_
{
    partial class Products
    {
        ...
        private void InitializeComponent()
        {
            ...
            // --- הגדרת פלטת הצבעים והפונטים לפי קונספט Obsidian & Champagne Gold ---
            ...
            Color mainBgColor = Color.FromArgb(18, 18, 18);          // שחור מט עמוק (Obsidian)
            Color panelBgColor = Color.FromArgb(28, 28, 28);         // אפור אובסידיאן כהה לשכבות ועומק
            Color goldAccent = Color.FromArgb(212, 175, 55);         // זהב שמפניה עשיר (Primary)
            Color copperAccent = Color.FromArgb(205, 127, 50);       // נחושת יוקרתית (Secondary)
            Color textCreamColor = Color.FromArgb(245, 245, 220);     // גוון שמנת רך לכותרות וטקסטים משניים
            Color textWhiteColor = Color.FromArgb(255, 255, 255);     // לבן מוחלט לקריאות מושלמת בנתונים וטבלאות
            Color borderDarkColor = Color.FromArgb(50, 50, 50);       // גבול עדין ויוקרתי לפאנלים ותיבות טקסט
            ...
            showProduct.Font = premiumFont;
            showProduct.BackColor = panelBgColor;
            showProduct.ForeColor = goldAccent;                       // החלפה לזהב שמפניה כמתבקש לכפתורי פעולה
            showProduct.FlatStyle = FlatStyle.Flat;
            showProduct.FlatAppearance.BorderColor = goldAccent;
            showProduct.FlatAppearance.BorderSize = 1;
            // 
            // deleteProduct
            // 
            ...
            deleteProduct.Font = premiumFont;
            deleteProduct.BackColor = panelBgColor;
            deleteProduct.ForeColor = copperAccent;                   // נחושת יוקרתית לפעולת מחיקה מיוחדת
            deleteProduct.FlatStyle = FlatStyle.Flat;
            deleteProduct.FlatAppearance.BorderColor = copperAccent;
            deleteProduct.FlatAppearance.BorderSize = 1;
            // 
            // showAllProducts
            // 
            ...
            showAllProducts.Font = premiumFont;
            showAllProducts.BackColor = panelBgColor;
            showAllProducts.ForeColor = goldAccent;                   // כפתור פעולה ראשי - זהב שמפניה
            showAllProducts.FlatStyle = FlatStyle.Flat;
            showAllProducts.FlatAppearance.BorderColor = goldAccent;
            showAllProducts.FlatAppearance.BorderSize = 1;
            // 
            // createProduct
            // 
            ...
            createProduct.Font = premiumFont;
            createProduct.BackColor = panelBgColor;
            createProduct.ForeColor = goldAccent;                     // זהב שמפניה
            createProduct.FlatStyle = FlatStyle.Flat;
            createProduct.FlatAppearance.BorderColor = goldAccent;
            createProduct.FlatAppearance.BorderSize = 1;
            // 
            // updateProduct
            // 
            ...
            updateProduct.Font = premiumFont;
            updateProduct.BackColor = panelBgColor;
            updateProduct.ForeColor = goldAccent;                     // זהב שמפניה
            updateProduct.FlatStyle = FlatStyle.Flat;
            updateProduct.FlatAppearance.BorderColor = goldAccent;
            updateProduct.FlatAppearance.BorderSize = 1;
            // 
            // panel1 (Create Product Panel)
            // 
            ...
            panel1.TabIndex = 4;
            panel1.BackColor = panelBgColor;                          // אפור אובסידיאן כהה לעומק
            // 
            // categoryComboBox
            // 
            ...
            categoryComboBox.Font = premiumFont;
            categoryComboBox.BackColor = mainBgColor;                 // רקע שחור מט פנימי
            categoryComboBox.ForeColor = textWhiteColor;              // טקסט לבן מוחלט
            // 
            // stockTextBox
            // 
            ...
            stockTextBox.Font = premiumFont;
            stockTextBox.BackColor = mainBgColor;
            stockTextBox.ForeColor = textWhiteColor;
            ...
            priceTextBox.Font = premiumFont;
            priceTextBox.BackColor = mainBgColor;
            priceTextBox.ForeColor = textWhiteColor;
            ...
            nameTextBox.Font = premiumFont;
            nameTextBox.BackColor = mainBgColor;
            nameTextBox.ForeColor = textWhiteColor;
            ...
            confirmCreate.BackColor = goldAccent;                     // כפתור אישור בזהב שמפניה יוקרתי
            confirmCreate.ForeColor = mainBgColor;                    // טקסט על הכפתור בשחור אובסידיאן לקונטרסט מושלם
            ...
            label4.ForeColor = textCreamColor;                        // גוון שמנת רך לכותרות
            // 
            // label3 (Stock Label)
            // 
            ...
            label3.ForeColor = textCreamColor;                        // גוון שמנת רך
            // 
            // label2 (Name Label)
            // 
            ...
            label2.ForeColor = textCreamColor;                        // גוון שמנת רך
            // 
            // label1 (Category Label)
            // 
            ...
            label1.ForeColor = textCreamColor;                        // גוון שמנת רך
            // 
            // panelID
            // 
            ...
            confirmAction.BackColor = goldAccent;                     // זהב שמפניה
            confirmAction.ForeColor = mainBgColor;                    // שחור מט פנימי
            ...
            idTextBox.ForeColor = textWhiteColor;
            ...
            labelID.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // panelUpdate
            // 
            ...
            categoryComboBoxUpdate.Font = premiumFont;
            categoryComboBoxUpdate.BackColor = mainBgColor;
            categoryComboBoxUpdate.ForeColor = textWhiteColor;
            // 
            // upStockTextBox
            // 
            ...
            upStockTextBox.Font = premiumFont;
            upStockTextBox.BackColor = mainBgColor;
            upStockTextBox.ForeColor = textWhiteColor;
            upStockTextBox.BorderStyle = BorderStyle.FixedSingle;
            // 
            // upPriceTextBox
            // 
            ...
            upPriceTextBox.Font = premiumFont;
            upPriceTextBox.BackColor = mainBgColor;
            upPriceTextBox.ForeColor = textWhiteColor;
            upPriceTextBox.BorderStyle = BorderStyle.FixedSingle;
            // 
            // upNameTextBox
            // 
            ...
            upNameTextBox.Font = premiumFont;
            upNameTextBox.BackColor = mainBgColor;
            upNameTextBox.ForeColor = textWhiteColor;
            upNameTextBox.BorderStyle = BorderStyle.FixedSingle;
            // 
            // UpdateConfirm
            // 
            ...
            UpdateConfirm.BackColor = goldAccent;                     // זהב שמפניה כצבע פעולה ראשי
            ...
            label8.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // label7
            // 
            ...
            label7.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // label6
            // 
            ...
            label6.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // label5
            // 
            ...
            label5.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // upIdTextBox
            // 
            ...
            upIdTextBox.ForeColor = textWhiteColor;
            ...
            DeleteConfirm.BackColor = copperAccent;                   // כפתור מחיקה סופית בנחושת יוקרתית (אלמנט מיוחד)
            DeleteConfirm.ForeColor = textWhiteColor;                 // טקסט לבן מוחלט
            ...
            idDeleteTextBox.ForeColor = textWhiteColor;
            ...
            filterByCategory.Font = premiumFont;
            filterByCategory.BackColor = mainBgColor;
            filterByCategory.ForeColor = goldAccent;                   // שונה לזהב שמפניה עשיר
            filterByCategory.FlatStyle = FlatStyle.Flat;
            filterByCategory.FlatAppearance.BorderColor = goldAccent;
            // 
            // label10
            // 
            ...
            label10.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            ...
            categoryFilterComboBox.Font = premiumFont;
            categoryFilterComboBox.BackColor = mainBgColor;
            categoryFilterComboBox.ForeColor = textWhiteColor;
            // 
            // closeShowAll
            // 
            ...
            closeShowAll.BackColor = Color.FromArgb(180, 40, 40);     // אדום עמוק ומעודן שמתאים לעיצוב הכהה
            closeShowAll.ForeColor = textWhiteColor;
            ...
            labelFilter.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // filterTextBox
            // 
            ...
            filterTextBox.ForeColor = textWhiteColor;
            ...
            // הגדרות עיצוב יוקרתי לטבלה - Obsidian & Champagne Gold
            dataGridViewProducts.BackgroundColor = panelBgColor;
            dataGridViewProducts.BorderStyle = BorderStyle.None;
            dataGridViewProducts.EnableHeadersVisualStyles = false;
            dataGridViewProducts.GridColor = borderDarkColor;
            dataGridViewProducts.ColumnHeadersDefaultCellStyle.BackColor = mainBgColor;
            dataGridViewProducts.ColumnHeadersDefaultCellStyle.ForeColor = goldAccent;       // כותרות הטבלה בזהב שמפניה
            dataGridViewProducts.ColumnHeadersDefaultCellStyle.Font = headerFont;
            dataGridViewProducts.DefaultCellStyle.BackColor = panelBgColor;
            dataGridViewProducts.DefaultCellStyle.ForeColor = textWhiteColor;                // נתונים בלבן מוחלט לקריאות
            dataGridViewProducts.DefaultCellStyle.Font = premiumFont;
            dataGridViewProducts.DefaultCellStyle.SelectionBackColor = Color.FromArgb(45, 45, 45); // רקע בחירה מעט בהיר יותר מהפאנל
            dataGridViewProducts.DefaultCellStyle.SelectionForeColor = goldAccent;           // טקסט נבחר מודגש בזהב שמפניה
            // 
            // label9
            // 
            ...
            label9.ForeColor = textCreamColor;                       // גוון שמנת רך
            // 
            // Products Form
            // 
            ...
            Name = "Products";
            Text = "Premium Products Management";
            Load += Products_Load;
            BackColor = mainBgColor;                                  // שחור מט עמוק (Obsidian)
            ForeColor = textWhiteColor;                               // טקסט ראשי בלבן מוחלט
            Font = premiumFont;
